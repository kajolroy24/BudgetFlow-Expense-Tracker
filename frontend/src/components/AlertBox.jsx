...
const AlertBox = ({ isOpen, closeAlert, onConfirm }) => {
    ...
    return (
        ...
        >
            <div className={`bg-white rounded-lg w-lg p-7 shadow-2xl transition-all
            ...
            >
                ...
                <div className="mt-4 flex gap-2">
                    ...
                    <button onClick={closeAlert} type="button" className="rounded-sm bg-gray-50 px-4 py-2 text-sm font-medium text-gray-600">
                        No, go back
                    </button>
                </div>
            </div>
