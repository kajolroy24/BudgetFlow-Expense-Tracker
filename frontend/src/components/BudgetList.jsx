...
const BudgetList = () => {
  ...
  return (
    <div className='mt-7'>
      <div className='grid grid-cols-1 md:grid-cols-2 [@media(max-width:850px)]:grid-cols-1 lg:grid-cols-3 gap-5'>
        <CreateBudget
        ...
        />
        {
          budgets.length > 0
            ...
            : [1, 2, 3, 4, 5].map((item, index) => (
              <div key={index} className='w-full bg-slate-200 dark:bg-gray-700 rounded-lg h-[144px] animate-pulse'></div>
            ))
