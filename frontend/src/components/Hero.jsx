...
const Hero = () => {
  ...
  return (
    <section className='bg-gray-50 dark:bg-[#140a2c] flex items-center flex-col'>
        ...
        titleComponent={
          <>
            <h1 className="text-4xl font-semibold text-black dark:text-white">
              ...
              <span className="text-4xl text-primary md:text-[8rem] font-bold mt-1 leading-none">
                Finance Advisor
              </span>
            </h1>
          </>
    ...
    <button
      ...
      className="fixed bottom-10 right-6 z-50 p-3.5 rounded-full shadow-md bg-primary hover:scale-105 transition-transform"
